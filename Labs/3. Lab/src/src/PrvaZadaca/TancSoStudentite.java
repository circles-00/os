...
public class TancSoStudentite {
    ...
    static Semaphore womanUndress;
    static Semaphore manUndress;
    static Semaphore pairWait;
    static Semaphore sceneWait;

    public void init() {
        //TODO: da se implementira
        womanUndress = new Semaphore(10);
        manUndress = new Semaphore(10);
        pairWait = new Semaphore(0);
        sceneWait = new Semaphore(3);
    }
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            womanUndress.acquire();
            show.presobleci();
            womanUndress.release();
            pairWait.release();
        }
